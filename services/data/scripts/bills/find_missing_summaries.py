...
사용법:
    python scripts/bills/find_missing_summaries.py [--output OUTPUT_PATH]

인자:
    --output: JSON 파일 저장 경로 (기본값: output/bills/missing_summaries.json)
"""
...
def main():
    ...
    parser.add_argument(
        ...
        help='JSON 파일 저장 경로 (기본값: output/bills/missing_summaries.json)'
    )
