...
def _add_ai_summary_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--failure-retry-attempts", type=int, default=1, help="배치 실패 항목의 단건 재시도 횟수, 0이면 비활성화")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    agent_report.add_argument("--failure-retry-attempts", type=int, default=1, help="배치 실패 항목의 단건 재시도 횟수, 0이면 비활성화")
